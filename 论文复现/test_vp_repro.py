...
SLOTFORMER_ROOT = '/home/lzy/project/slot-datamaking/SlotFormer-master'
VIDEO_PRED_ROOT = os.path.join(SLOTFORMER_ROOT, 'slotformer',
                               'video_prediction')
sys.path.insert(0, SLOTFORMER_ROOT)
sys.path.insert(0, VIDEO_PRED_ROOT)
